...
switch (OP){
	...
	break;	
		...
		case 5:
			...
			cout<< "Um virabrequim, também chamado de eixo de manivela, está localizado  " <<endl <<"no motor de um veículo e converte a força criada por pistões do motor,  " <<endl <<"que se movem para cima e  para baixo, em uma força que gira as rodas do  " <<endl <<"automóvel em um movimento circular de modo que o carro possa ir para a frente."   <<endl <<endl ;
